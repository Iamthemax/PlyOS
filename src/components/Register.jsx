...
export default function Register() {
  ...
  const handlePickProfileImage = async () => {
    try {
      console.log('called profile image pick')
      ...
      <ScrollView contentContainerStyle={[styles.bgwhite]}>
        <ImageBackground source={require('../../assets/img/main_bg.jpg')} style={{ borderRadius: 30, flex: 1, borderTopLeftRadius: 30, borderTopRightRadius: 30, overflow: 'hidden' }}>
          ...
          /> */}
            ...
            <TextInput  maxLength={15}         autoCapitalize="characters" 
 style={styles1.mbboot} mode="outlined" onChangeText={e => setgstNumber(e)} value={gstNumber} placeholder="GST NO.* ( 15 digit GSTIN) " placeholderTextColor="#000" selectionColor={CustomColors.mattBrownDark} />
          ...
          /> */}
            ...
            {role !== ROLES_CONSTANT.USER && (
              ...
              /> */}
                ...
                }} style={styles1.mbboot} mode="outlined" value={profileImage} editable={false} placeholder="Profile Photo" placeholderTextColor="#000" selectionColor={CustomColors.mattBrownDark} />
  ...
  <TextInput 
    ...
    onPress={() => handlePickBannerImage()} // Ensures TextInput also triggers action
  />
...
<View style={styles1.dropdown}>
  ...
  <Entypo name='chevron-small-down' color='#000' size={16} />
         ...
         /> */}
              ...
              <Pressable onPress={() => navigation.navigate('Login')} style={[{ alignItems: 'center', justifyContent: 'center', width: wp(93), marginTop: 10, flexDirection: 'row' }]}>
        ...
        <View style={styles1.centeredView}>
          <View style={styles1.modalView}>
            ...
            <DatePicker 
              ...
              date={aniversaryDate} 
              mode="date" 
              onDateChange={setAniversaryDate} 
              textColor={'white'} 
            />
